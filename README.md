...
<img src="https://capsule-render.vercel.app/api?type=soft&color=0:0f172a,100:0891b2&height=130&section=header&text=Guilherme%20Botingnon&fontSize=34&fontColor=ffffff" width="100%" alt="Guilherme Botingnon" />
...
**Desenvolvedor Full Stack** focado em sistemas em produção — da API ao deploy em **Docker Swarm**.

Com **1+ ano de entregas reais**, atuo em automação, e-commerce e infraestrutura self-hosted. Gosto de construir soluções completas: backend, front-end React/Next.js, PWAs, integrações com IA e ambientes com Traefik e TLS.
...
<img src="https://skillicons.dev/icons?i=nodejs,typescript,react,nextjs,graphql,php,docker,postgres,mysql,mongodb,redis,linux,git,nginx,python,tailwind,vue,figma&perline=4&theme=dark" alt="Tech stack" />
...
Automação de dados, integrações e pipelines com IA<br/>
...
<td width="72%" valign="top">
Desenvolvimento e manutenção de loja Magento 2<br/>
...
<td width="72%" valign="top">
Freelancer — landing pages, automações e entregas sob demanda<br/>
...
<td width="72%" valign="top">
Infraestrutura própria, homelab e projetos pessoais em produção<br/>
